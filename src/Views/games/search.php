    ...
    <main class="max-w-7xl mx-auto px-6">
        ...
        <div class="bg-zinc-900 p-6 sm:p-8 rounded-sm border-2 border-zinc-800 mb-10 shadow-xl max-w-4xl mx-auto">
            <form action="index.php" method="GET" class="flex flex-col sm:flex-row gap-3">
                ...
                <div class="flex-1">
                    <input type="text" name="q" placeholder="Ex: The Witcher 3, Elden Ring, Minecraft..." value="<?php echo isset($_GET['q']) ? htmlspecialchars($_GET['q']) : ''; ?>" required
        ...
        <?php if (!empty($results)): ?>
            <h2 class="text-xl font-black text-white uppercase tracking-tight border-l-4 border-violet-500 pl-3 mb-6">Resultados para "<?php echo htmlspecialchars($_GET['q']); ?>"</h2>
                ...
                <?php foreach ($results as $game): ?>
                    ...
                    <div class="bg-zinc-900 border-2 border-zinc-800 rounded-sm shadow-xl flex flex-col overflow-hidden group">
                        ...
                        <div class="h-48 sm:h-56 bg-zinc-950 border-b-2 border-zinc-800 overflow-hidden relative">
                            ...
                            <!-- Etiqueta de Lançamento Flutuante -->
                        ...
                        <div class="p-4 flex flex-col flex-1">
                            ...
                            <p class="text-xs font-bold text-zinc-500 uppercase tracking-wider mb-4 line-clamp-1">
                                ...
                                echo !empty($genres) ? htmlspecialchars(implode(' • ', $genres)) : 'Gênero Desconhecido';
                                ?>
                            </p>
                            
                            <!-- Formulário Oculto de Inserção -->
        ...
        <?php elseif (isset($_GET['q'])): ?>
            <div class="bg-zinc-900 border-2 border-zinc-800 rounded-sm p-12 text-center shadow-xl mt-8">
                ...
                <p class="text-sm mt-2 text-zinc-600 font-bold uppercase tracking-widest">Verifique a ortografia ou tente outro termo.</p>
            </div>
        <?php endif; ?>
